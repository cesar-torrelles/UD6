...
public class ejercicio10App {
	...
	public static void main(String[] args) {
		...
		// Solicitamos las dimensiones del Array y convertimos los datos a valor
		// numérico
		...
		// solicitamos el rango minimo del randomizador que usaremos mas adelante y
		// convertimos los datos a valor numérico
		...
		// solicitamos el rango maximo del randomizador que usaremos mas adelante y
		// convertimos los datos a valor numérico
	...
	// el metodo input nos rellenara el Array con numeros random (dentro de este
	// metodo llamaremos a otro metodo para seleccionar los numeros primos)
	...
	// creamos el metodo Output para imprimir todos los numeros (previamente
	// seleccionados como primos) que se han guardado en el Array
	public static void metodoOutput(int[] arreglo) {

		// imprimimos un texto comunicando los numeros filtrados que apareceran a
		// continuacion
	...
	// en este metodo seleccionaremos el numero mayor de entre todos los numeros
	// seleccionados
